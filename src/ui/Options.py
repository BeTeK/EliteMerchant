...
class Options(ui.OptionsUI.Ui_Dialog, QtWidgets.QDialog):
    def __init__(self, db, analyzer, parent = None):
        ...
        self.searchAutoLogChk.setChecked(OptionsParams.get("search-auto-log-enabled", "0") != "0")
        self.searchAutoLogChk.stateChanged.connect(self.onSearchAutoLogChanged)
        self.searchAutoEDCEChk.setChecked(OptionsParams.get("search-auto-edce-enabled", "1") != "0")
