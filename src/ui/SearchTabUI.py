...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.windowCountSpinBox.setStyleSheet("background:rgb(255,255,255)")
        ...
        self.windowSizeSpinBox.setStyleSheet("background:rgb(255,255,255)")
        ...
        Dialog.setTabOrder(self.minProfitSpinBox, self.searchTypeCombo)
        Dialog.setTabOrder(self.searchTypeCombo, self.graphDepthSpin)
        Dialog.setTabOrder(self.graphDepthSpin, self.graphMinDepthSpin)
        Dialog.setTabOrder(self.graphMinDepthSpin, self.maxDistanceSpinBox)
        Dialog.setTabOrder(self.maxDistanceSpinBox, self.windowSizeSpinBox)
        Dialog.setTabOrder(self.windowSizeSpinBox, self.windowCountSpinBox)
        Dialog.setTabOrder(self.windowCountSpinBox, self.searchBtn)
