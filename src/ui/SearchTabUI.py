...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.graphMinDepthSpin, 4, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.searchTypeCombo, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.graphDepthSpin, 3, 5, 1, 1)
        ...
        self.gridLayout.addLayout(self.startingsystemlayout, 1, 3, 1, 1)
        ...
        self.gridLayout.addLayout(self.targetsystemlayout, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.currentSystemCombo, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.targetSystemCombo, 3, 1, 1, 1)
        ...
        self.horizontalLayout_3.addWidget(self.minProfitSpinBox)
        self.smugglingCheckBox = QtWidgets.QCheckBox(Dialog)
        self.smugglingCheckBox.setObjectName("smugglingCheckBox")
        self.horizontalLayout_3.addWidget(self.smugglingCheckBox)
        ...
        Dialog.setTabOrder(self.minProfitSpinBox, self.smugglingCheckBox)
        Dialog.setTabOrder(self.smugglingCheckBox, self.maxDistanceSpinBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_14.setText(_translate("Dialog", "Min trade hops"))
        self.label_8.setText(_translate("Dialog", "Max trade hops"))
        ...
        self.smugglingCheckBox.setToolTip(_translate("Dialog", "<html><head/><body><p>Black market trades, or Smuggling is a fun and efficient way to make money in 1.3, especially with the faction bonuses.</p><p>Black market trades are marked with a skull and a black background in search results.</p><p>NOTE! Black market prices are unreliable.</p><p>Prices shown are copied from legal stations in the same system, but actual price may be incorrect.</p></body></html>"))
        self.smugglingCheckBox.setText(_translate("Dialog", "Black Market"))
