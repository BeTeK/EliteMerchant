...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ElitePathTxt1 = QtWidgets.QLineEdit(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ElitePathTxt1.sizePolicy().hasHeightForWidth())
        self.ElitePathTxt1.setSizePolicy(sizePolicy)
        self.ElitePathTxt1.setObjectName("ElitePathTxt1")
        self.horizontalLayout_31.addWidget(self.ElitePathTxt1)
        self.ElitePathBtn1 = QtWidgets.QPushButton(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ElitePathBtn1.sizePolicy().hasHeightForWidth())
        self.ElitePathBtn1.setSizePolicy(sizePolicy)
        self.ElitePathBtn1.setObjectName("ElitePathBtn1")
        self.horizontalLayout_31.addWidget(self.ElitePathBtn1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ElitePathBtn1.setText(_translate("Dialog", "..."))
